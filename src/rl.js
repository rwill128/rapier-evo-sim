...
(function (global) {
    ...
    Mat.prototype = {
        ...
        setFromWithErrors: function (arr) {
            let shortest_array = Math.min(arr.length, this.w.length);
            for (var i = 0, n = shortest_array; i < n; i++) {
                this.w[i] = arr[i] + (Math.random() * 2 - 1);
            }
        },
...
// - learns from experience :)
    ...
    DQNAgent.prototype = {
        reset: function () {
            ...
            this.net.W2 = new R.RandMat(this.nh, this.nh, 0, 0.01);
            this.net.b2 = new R.Mat(this.nh, 1, 0, 0.01);
        ...
        forwardQ: function (net, s, needs_backprop) {
            ...
            var h1mat = G.sigmoid(a1mat);
            var a2mat = G.add(G.mul(net.W2, h1mat), net.b2);
            var h2mat = G.sigmoid(a2mat);
...
// buggy implementation, doesnt work...
    ...
    SimpleReinforceAgent.prototype = {
        reset: function () {
            this.ns = this.env.getNumStates();
            this.na = this.env.getMaxNumActions();
            this.nh = 20; // number of hidden units
            this.nhb = 20; // and also in the baseline lstm

            this.actorNet = {};
            this.actorNet.W1 = new R.RandMat(this.nh, this.ns, 0, 0.01);
            this.actorNet.b1 = new R.Mat(this.nh, 1, 0, 0.01);
            this.actorNet.W2 = new R.RandMat(this.na, this.nh, 0, 0.01);
        ...
        act: function (slist) {
            ...
            for (var i = 0; i < this.env.getMaxNumActions(); i++) {
                a.w[i] = R.randn(amat.w[i], gaussVar);
            }
